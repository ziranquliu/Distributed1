<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddUser.aspx.cs" Inherits="DistributedWeb_MG.AddUser" %>
...
<table width="99%" border="0" cellpadding="0" cellspacing="0" class="CContent">
  ...
  <tr>
    <td class="CPanel">
		<input type="hidden" runat="server" id="userobjId" />
        <input type="hidden" runat="server" id="loginuserobjId" />
